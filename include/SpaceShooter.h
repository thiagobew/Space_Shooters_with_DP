...
public:
    ...
    static void run(void *name)
    {
        ...
        whiteShipsControlThread = new Thread(whiteShipsFunc);
        ...
        // std::cout << "Esperando whiteShipsControlThread\n";
        whiteShipsControlThread->join();
        ...
        // std::cout << "Deletando White\n";
        delete whiteShipsControlThread;
...
private:
    ...
    static void whiteShipsFunc() {
        whiteShipsControlObj = new WhiteEnemiesControl();
        whiteShipsControlObj->setCollisionReference(collisionObj);
        whiteShipsControlObj->setWindowReference(windowObj);
        whiteShipsControlObj->setPlayerReference(playerShipObj);
        whiteShipsControlObj->run();
        delete whiteShipsControlObj;
        whiteShipsControlThread->thread_exit(0);
    }
    ...
    static Thread *whiteShipsControlThread;
    ...
    static WhiteEnemiesControl *whiteShipsControlObj;
};
